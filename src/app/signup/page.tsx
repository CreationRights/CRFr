      ...
      <PageSection className="flex items-center justify-center min-h-[calc(100vh-4rem)]">
        <div className="w-full max-w-md">
          <div className="text-center mb-8">
            ...
            <p className="text-muted-foreground">Join thousands of creators protecting their work</p>
          </div>
            ...
            <form className="space-y-6">
              ...
              <div>
                <label className="flex items-start space-x-3">
                  <input
                    type="checkbox"
                    className="w-4 h-4 mt-1 rounded border-border bg-card  focus:ring-foreground focus:ring-offset-0"
                  />
